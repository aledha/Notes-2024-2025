[
    ...
    {trigger: "bm", replacement: "$$\n\\begin{equation}\n$0\n\\end{equation}\n$$", options: "tw"},
    {trigger: "bms", replacement: "$$\n\\begin{equation*}\n$0\n\\end{equation*}\n$$", options: "tw"},
    {trigger: "am", replacement: "$$\n\\begin{align}\n$0\n\\end{align}\n$$", options: "tw"},
    {trigger: "ams", replacement: "$$\n\\begin{align*}\n$0\n\\end{align*}\n$$", options: "tw"},
    ...
    // Parenthesis
    {trigger: "cur", replacement: "\\{$0\\}$1", options: "mA"},
    // Basic operations
    ...
    {trigger: "1inv", replacement: "^{-1}", options: "mA"},
    {trigger: "2inv", replacement: "^{-2}", options: "mA"},
    {trigger: "3inv", replacement: "^{-3}", options: "mA"},
    {trigger: /([A-Za-z])(\d)/, replacement: "[[0]]_{[[1]]}", options: "rm", description: "Auto letter subscript", priority: -1},
    ...
    {trigger: "unit", replacement: "\\,\\mathrm{$0}$1", options: "mA"},
	...
	{trigger: "\\\\(${GREEK})\\.,", replacement: "\\boldsymbol{\\[[0]]}", options: "rmA"},
    {trigger: "0,\\.", replacement: "\\boldsymbol{0}$0", options: "rmA"},
	{trigger: "0\\.,", replacement: "\\boldsymbol{0}$0", options: "rmA"},
    ...
    {trigger: "grad", replacement: "\\text{Grad}$0", options: "mA"},
    ...
    {trigger: "par2", replacement: "\\frac{ \\partial^2 ${0:y} }{ \\partial ${1:x}^2 } $2", options: "m"},
    {trigger: "part", replacement: "\\partial", options: "mA"},
    {trigger: /pa([A-Za-z])([A-Za-z])/, replacement: "\\frac{ \\partial [[0]] }{ \\partial [[1]] } ", options: "rm"},
    {trigger: "ddt", replacement: "\\frac{\\text{d}$0}{\\text{d}t} $1", options: "mA"},
    {trigger: "dd", replacement: "\\frac{ \\text{d} ${0:y} }{ \\text{d} ${1:t} } $2", options: "m"},
    {trigger: "d([A-Za-z])d([A-Za-z])", replacement: "\\frac{\\text{d}[[0]]}{\\text{d}[[1]]} ", options: "rm"},
    ...
    {trigger: "der", replacement: "\\,\\text{d} $0", options: "mA"},

    {trigger: "label", replacement: "%\\label{eq:$0}", options: "mA"},
    {trigger: "non", replacement: "\\nonumber", options: "mA"},
    // Trigonometry
    ...
    {trigger: "R", replacement: "\\mathrm{ ${VISUAL} }", options: "mA"},
